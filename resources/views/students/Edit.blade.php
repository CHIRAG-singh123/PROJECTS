...
@section('content')
<div>
    <h2>ADD STUDENT DETAILS TO BE EDIT</h2>
</div>
@if ($errors->any())
    <div>
      ...
      <form   action="{{ route('students.update',$student->id)}}" method="POST">
        ...
        <div class="account-type">
            <label><b>Student's Name : </b></label>
                    <input type="text" name="studname" value="studentname" class="form-control" placeholder="Your name">
          
        </div>
        <hr>
        <label><b>Student's Stream : </b></label>
        <input type="text" name="stream"class="form-control" value="$student->stream" placeholder="Stream[M.C.A/MSc(I.T)">
        <hr>
        <label><b>Student's Semister : </b></label>
                    <input type="text" name="sem"class="form-control" value="$student->sem" placeholder="Sem-7">
        <hr>
        <label><b>Student's Div : </b></label>
                    <input type="text" name="div" class="form-control" value="$student->div" placeholder="Div">
        <hr>
        <label><b>Student's Course : </b></label>
        <input type="text" name="course"class="form-control" value="$student->course" placeholder="Course era Course">
                    <hr>
        <div class="btn-block">
